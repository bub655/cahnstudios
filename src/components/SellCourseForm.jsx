      ...
      <div className="w-full max-w-lg bg-white rounded-lg shadow-md p-8">
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 mb-8 text-center border border-green-100">
          <h3 className="text-lg font-semibold text-gray-800 mb-3">
            🎯 Exclusively Lowered Prices
          </h3>
          <div className="flex items-center justify-center gap-4 mb-3">
            <div className="text-center">
              <span className="text-sm text-gray-500 block">Was</span>
              <span className="text-2xl text-gray-500 line-through font-bold">$60</span>
            </div>
            <div className="text-center">
              <span className="text-sm text-green-600 block">Now Only</span>
              <span className="text-4xl text-green-600 font-bold">$20</span>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full py-3 text-lg font-semibold transition rounded-full ${
                isRegistering
                  ...
                  : 'bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-700 text-white hover:from-blue-700 hover:via-blue-600 hover:to-indigo-800'
              }`}
            >
              {isRegistering ? (
            ...
            <p className="mt-6 text-sm text-gray-500 text-center">Secure checkout powered by Stripe.</p>
          </div>
        </form>
      </div>
    </section>
